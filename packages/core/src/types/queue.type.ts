...
export interface QueueService {
   ...
   */
  init?: (options: QueueServiceOptions) => Promise<void>;
   ...
   */
  listTopics: (options: QueueServiceOptions) => Promise<string[]>;
   ...
   */
  createTopic: (topicId: string, options: QueueServiceOptions) => Promise<void>;
   ...
   */
  deleteTopic: (topicId: string, options: QueueServiceOptions) => Promise<void>;
   ...
   * @throws never.
   */
  hasTopic: (topicId: string, options: QueueServiceOptions) => Promise<boolean>;
